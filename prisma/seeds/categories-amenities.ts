...
// --- HELPER: Slugify to ensure uniqueness ---
// Appends parent slug to child to avoid collisions (e.g., "ac-service-repair" vs "car-service-repair")
function generateSlug(text: string, parentSlug: string = ""): string {
  ...
  return parentSlug ? `${parentSlug}-${cleanText}` : cleanText;
}

// --- DATA: Raw Categories from paste.txt ---
const rawCategories = [
  {
    text: "AC Service",
    iconSrc: null,
    subCategories: [
      {
        ...
        subSubCategories: [
          { text: "New AC installation" },
          { text: "Uninstallation" },
          { text: "AC shifting" },
          { text: "Copper pipe fitting" },
          { text: "Stand/Bracket installation" }
        ]
      },
      {
        text: "Repair",
        subSubCategories: [
          ...
          { text: "PCB/Capacitor issue" },
          { text: "Compressor issue" }
        ]
      },
      {
        text: "Maintenance",
        subSubCategories: [
          ...
          { text: "Deep cleaning" },
          { text: "Gas refill/charging" },
          { text: "Gas leak fix" },
          { text: "Annual maintenance contract (AMC)" }
        ]
      }
    ]
  },
    ...
    subCategories: [
      ...
      },
      {
        ...
        subSubCategories: [
          ...
          { text: "Janam patri analysis" },
          { text: "Daily/weekly horoscope" },
          { text: "Numerology report" }
        ]
      },
      {
        text: "Remedies & rituals",
        subSubCategories: [
          { text: "Puja/havan" },
          { text: "Vastu correction" },
          { text: "Gemstone recommendation" },
          { text: "Yantra/totka guidance" },
          { text: "Muhurat selection" }
        ]
      }
    ]
  },
  {
    text: "Body Massage Centers",
    iconSrc: null,
    subCategories: [
      {
        text: "Massage types",
    ...
    subCategories: [
      {
        text: "Tax",
        subSubCategories: [
          { text: "Income tax return (ITR)" },
          { text: "Tax planning" },
          { text: "TDS filing" },
          { text: "Tax notice reply" },
          { text: "Advance tax" }
        ]
      },
      {
  ...
  {
    text: "Computer Training Institutes",
    iconSrc: null,
    subCategories: [
      {
        text: "Programming",
  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        subSubCategories: [
          { text: "E-commerce shipping" },
          { text: "Reverse logistics" },
          { text: "Tracking integration" },
          { text: "Packaging" },
          { text: "Insurance" }
        ]
      }
  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        subSubCategories: [
          { text: "Short circuit" },
          { text: "Power trip issue" },
          { text: "Wiring repair" },
          { text: "Socket replacement" },
          { text: "Earthing" }
        ]
      },
      {
    ...
    subCategories: [
      {
        text: "Property type",
        subSubCategories: [
          { text: "Residential buy" },
          { text: "Residential rent" },
  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        text: "Custom jobs",
        subSubCategories: [
          { text: "Staircase fabrication" },
          { text: "Balcony railing" },
          { text: "Canopy" },
          { text: "Metal furniture" },
          { text: "Partition frames" }
        ]
      },
      {
        text: "Finishing",
  ...
  {
    text: "Furniture Repair Services",
    iconSrc: null,
    subCategories: [
      {
        text: "Wood furniture",
      ...
      },
      {
        ...
        subSubCategories: [
          { text: "Sofa repair" },
          { text: "Cushion replacement" },
          { text: "Foam change" },
          { text: "Fabric change" },
          { text: "Recliner repair" }
        ]
      },
      {
        text: "Polish & restoration",
        subSubCategories: [
          { text: "Wood polishing" },
          { text: "Touch-up" },
          { text: "Termite damage repair" },
          { text: "Refinishing" },
  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        text: "Commercial",
        subSubCategories: [
          { text: "Office housekeeping" },
          { text: "Society housekeeping" },
  ...
  {
    text: "Internet Website Designers",
    iconSrc: null,
    subCategories: [
      {
        text: "Website types",
  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        text: "Services",
        subSubCategories: [
          { text: "Buyback/exchange" },
          { text: "Jewellery repair" },
          { text: "Polishing" },
          { text: "Custom design" },
          { text: "Certification" }
        ]
  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        subSubCategories: [
          { text: "Day attendant" },
          { text: "Night attendant" },
          { text: "24-hour attendant" },
          { text: "Patient sitter" },
          { text: "Physio assistant" }
        ]
      },
      {
  ...
  {
    text: "Printing & Publishing Services",
    iconSrc: null,
    subCategories: [
      {
        text: "Printing",
      ...
      },
      {
        text: "Publishing",
        subSubCategories: [
          { text: "ISBN assistance" },
          { text: "E-book formatting" },
          { text: "Proofreading" },
          { text: "Cover design" },
    ...
    subCategories: [
      ...
      },
      {
        ...
        subSubCategories: [
          ...
          { text: "Crack filling" },
          { text: "Sanding/priming" },
          { text: "Stain removal" },
          { text: "Post-paint cleanup" }
        ]
      },
      {
        text: "Surfaces",
    ...
    subCategories: [
      {
        ...
        subSubCategories: [
          { text: "Local shifting" },
          { text: "Intercity shifting" },
          { text: "Office shifting" },
          { text: "Vehicle shifting" },
      ...
      },
      {
        ...
        subSubCategories: [
          { text: "Insurance" },
          { text: "Dismantle/assemble" },
          { text: "Labour" },
          { text: "Lift availability" },
          { text: "On-site survey" }
        ]
      }
    ]
    ...
    subCategories: [
      ...
      },
      {
        ...
        subSubCategories: [
          { text: "Door pickup" },
          { text: "Bulk pickup" },
          { text: "Warehouse pickup" },
          { text: "Industrial scrap" },
          { text: "Regular contracts" }
        ]
      },
      {
        text: "Services",
        subSubCategories: [
          ...
          { text: "Rate quotation" },
          { text: "Segregation" },
          { text: "Demolition scrap" },
          { text: "E-waste handling" }
        ]
      }
    ]
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        text: "Source",
        subSubCategories: [
          { text: "Household scrap" },
          { text: "Office scrap" },
          { text: "Factory scrap" },
          { text: "Construction scrap" },
          { text: "E-waste" }
        ]
      },
      {
        ...
        subSubCategories: [
          { text: "Spot purchase" },
          { text: "Monthly contract" },
          { text: "On-site pickup" },
          { text: "Cash/UPI payment" },
          { text: "Rate negotiation" }
        ]
      }
    ]
  },
  {
    text: "Registration Consultants",
    iconSrc: null,
    subCategories: [
      {
        ...
        subSubCategories: [
          { text: "GST registration" },
          { text: "Firm registration" },
          { text: "Company incorporation" },
          { text: "MSME/Udyam" },
          { text: "Shop & establishment" }
        ]
      },
      {
        text: "Personal docs",
    ...
    subCategories: [
      {
        text: "Technical",
        subSubCategories: [
          { text: "Electrician course" },
          { text: "Plumbing course" },
          { text: "AC technician" },
          { text: "Welding" },
          { text: "Automobile repair" }
        ]
      },
      {
        text: "Beauty & wellness",
        subSubCategories: [
          { text: "Beautician course" },
          { text: "Hair styling" },
          { text: "Makeup" },
          { text: "Spa therapy" },
          { text: "Nail art" }
    ...
    subCategories: [
      {
        ...
        subSubCategories: [
          { text: "Leak fixing" },
          { text: "Tap & mixer repair" },
          { text: "Flush repair" },
          { text: "Blockage removal" },
          { text: "Bathroom fittings" }
        ]
      },
      {
        text: "Installations",
  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        text: "Services",
        subSubCategories: [
          { text: "Measurement visit" },
          { text: "Hardware fitting" },
          { text: "Polish work" },
          { text: "Custom shelves" },
          { text: "Modular fixes" }
        ]
    ...
    subCategories: [
      {
        text: "Deep cleaning",
        subSubCategories: [
          { text: "Kitchen deep clean" },
          { text: "Bathroom deep clean" },
          { text: "Full home deep clean" },
      ...
      },
      {
        ...
        subSubCategories: [
          ...
          { text: "Water tank cleaning" },
          { text: "Kitchen chimney cleaning" }
        ]
      },
      {
        text: "Hygiene",
        subSubCategories: [
          ...
          { text: "Kitchen sanitization" },
          { text: "Pest-prep cleaning" },
          { text: "Post-illness cleaning" }
        ]
      }
    ]
  },
  {
    text: "Salon (Men/Women)",
    iconSrc: null,
    subCategories: [
      {
        text: "Women",
...
// --- DATA: Amenities from original file ---
const amenities = [
  // Payment
...
async function seedCategoriesAndAmenities() {
  ...
  // 1. Process Hierarchical Categories
  for (const [index, mainCat] of rawCategories.entries()) {
    // A. Main Category (Level 1)
    const mainSlug = generateSlug(mainCat.text);
    const createdMainCat = await prisma.category.upsert({
      where: { slug: mainSlug },
      update: {
        name: mainCat.text,
        icon: mainCat.iconSrc,
        displayOrder: index + 1,
        isFeatured: true, // Marking main categories as featured by default
      },
      create: {
        name: mainCat.text,
        slug: mainSlug,
    ...
    if (mainCat.subCategories) {
      for (const [subIndex, subCat] of mainCat.subCategories.entries()) {
        // B. Sub Category (Level 2)
        const subSlug = generateSlug(subCat.text, mainSlug); // Hierarchical slug
        ...
        if (subCat.subSubCategories) {
          for (const [subSubIndex, subSubCat] of subCat.subSubCategories.entries()) {
            // C. Sub-Sub Category (Level 3)
            const subSubSlug = generateSlug(subSubCat.text, subSlug); // Hierarchical slug
            await prisma.category.upsert({
              where: { slug: subSubSlug },
              update: {
                name: subSubCat.text,
                parentId: createdSubCat.id,
                displayOrder: subSubIndex + 1,
              },
              create: {
                name: subSubCat.text,
                slug: subSubSlug,
  ...
  console.log(`✅ Upserted ${categoryCount} categories (Main, Sub & Nested)`);
